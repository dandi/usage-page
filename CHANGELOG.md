...
- Drew the region map's continent labels in black on a white halo, so they stay readable over the choropleth's fills. ([#266](https://github.com/dandi/usage-page/pull/266))
